...
set_button = tk.Button(root, text="Set", command=clear_text, bg="blue", fg="white")  # زر Set بلون أزرق
set_button.pack(pady=5)

exit_button = tk.Button(root, text="Exit", command=exit_app, bg="red", fg="white")  # زر Exit بلون أحمر
